...
#define ADDR_REG_AHB1ENR ((RCC_AHB1ENR_t*) (0x40023800 + 0x30));  // base addr + offset
#define ADDR_REG_GPIOx_MODER ((GPIOx_MODER_t*) (0x40020C00 + 0x00));  // base addr + offset
#define ADDR_REG_GPIOx_ODR ((GPIOx_ODR_t*) (0x40020C00 + 0x14));  // base addr + offset
